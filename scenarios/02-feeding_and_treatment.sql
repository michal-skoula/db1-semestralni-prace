...
-- =============================================================================
--  Popis: Demonstrace procesu krmení zvířete, při kterém je objevena zdravotní
--         komplikace vyžadující veterinární zákrok. Scénář ukazuje práci
--         s transakcemi a aktualizaci skladových zásob.
-- =============================================================================
...
-- -----------------------------------------------------------------------------
-- Celý zákrok (uspání + dezinfekce) je proveden v jedné transakci.
-- Důvod: Jedná se o jeden logický celek - bez uspání nelze provést dezinfekci.
-- V případě selhání kterékoliv operace dojde k rollbacku celé transakce.

BEGIN;

-- Fáze 1: Uspání zvířete
